...
def clean_numeric(value, conversion_func):
...
def fielddata_create(request):
    if request.method == 'POST':
        ...
        planting_date_str = data.get('plantingDate', '').strip()
        plantingDate = datetime.strptime(planting_date_str, '%Y-%m-%d').date() if planting_date_str else None

        harvest_date_str = data.get('harvestDate', '').strip()
        harvestDate = datetime.strptime(harvest_date_str, '%Y-%m-%d').date() if harvest_date_str else None
        
        new_fielddata = FieldData(
            studyYear=clean_numeric(data.get('studyYear', ''),int),
            programDbId=data.get('programDbId', ''),
            ...
            plotWidth=clean_numeric(data.get('plotWidth', ''),float),
            plotLength=clean_numeric(data.get('plotLength', ''),float),
            fieldSize=clean_numeric(data.get('fieldSize', ''),float),
            plantingDate=plantingDate,
            harvestDate=harvestDate,
            locationDbId=data.get('locationDbId', ''),
            locationName=data.get('locationName', ''),
            germplasmDbId=data.get('germplasmDbId', ''),
            germplasmName=data.get('germplasmName', ''),
            germplasmSynonyms=data.get('germplasmSynonyms', ''),
            observationLevel=data.get('observationLevel', ''),
            observationUnitDbId=data.get('observationUnitDbId', ''),
            observationUnitName=data.get('observationUnitName', ''),
            replicate=clean_numeric(data.get('replicate', ''),int),
            blockNumber=clean_numeric(data.get('blockNumber', ''),int),
            plotNumber=clean_numeric(data.get('plotNumber', ''),int),
            entryType=data.get('entryType', ''),
            boiled_storage_root_color=data.get('boiled_storage_root_color', ''),
            cassava_anthractnose_disease_incidence_6_month=clean_numeric(data.get('cassava_anthractnose_disease_incidence_6_month', ''),float),
            cassava_anthractnose_disease_incidence_9_month=clean_numeric(data.get('cassava_anthractnose_disease_incidence_9_month', ''),float),
            cassava_anthractnose_disease_severity_6_month=clean_numeric(data.get('cassava_anthractnose_disease_severity_6_month', ''),float),
            cassava_anthractnose_disease_severity_9_month=clean_numeric(data.get('cassava_anthractnose_disease_severity_9_month', ''),float),
            cassava_bacterial_blight_incidence_3_month=clean_numeric(data.get('cassava_bacterial_blight_incidence_3_month', ''),float),
            cassava_bacterial_blight_incidence_6_month=clean_numeric(data.get('cassava_bacterial_blight_incidence_6_month', ''),float),
            cassava_bacterial_blight_severity_3_month=clean_numeric(data.get('cassava_bacterial_blight_severity_3_month', ''),float),
            cassava_bacterial_blight_severity_6_month=clean_numeric(data.get('cassava_bacterial_blight_severity_6_month', ''),float),
            cassava_green_mite_severity_first_evaluation=clean_numeric(data.get('cassava_green_mite_severity_first_evaluation', ''),float),
            cassava_green_mite_severity_second_evaluation=clean_numeric(data.get('cassava_green_mite_severity_second_evaluation', ''),float),
            cassava_mosaic_disease_incidence_1_month=clean_numeric(data.get('cassava_mosaic_disease_incidence_1_month', ''),float),
            cassava_mosaic_disease_incidence_3_month=clean_numeric(data.get('cassava_mosaic_disease_incidence_3_month', ''),float),
            cassava_mosaic_disease_incidence_6_month=clean_numeric(data.get('cassava_mosaic_disease_incidence_6_month', ''),float),
            cassava_mosaic_disease_severity_1_month=clean_numeric(data.get('cassava_mosaic_disease_severity_1_month', ''),float),
            cassava_mosaic_disease_severity_3_month=clean_numeric(data.get('cassava_mosaic_disease_severity_3_month', ''),float),
            cassava_mosaic_disease_severity_6_month=clean_numeric(data.get('cassava_mosaic_disease_severity_6_month', ''),float),
            dry_matter_content_specific_gravity_method=clean_numeric(data.get('dry_matter_content_specific_gravity_method', ''),float),
            dry_matter_content_percentage=clean_numeric(data.get('dry_matter_content_percentage', ''),float),
            ease_of_peeling_root_cortex_visual_rating=clean_numeric(data.get('ease_of_peeling_root_cortex_visual_rating', ''),int),
            first_apical_branch_height_cm=clean_numeric(data.get('first_apical_branch_height_cm', ''),float),
            fresh_shoot_weight_kg_per_plot=clean_numeric(data.get('fresh_shoot_weight_kg_per_plot', ''),float),
            fresh_storage_root_weight_per_plot=clean_numeric(data.get('fresh_storage_root_weight_per_plot', ''),float),
            harvest_index_variable=clean_numeric(data.get('harvest_index_variable', ''),float),
            initial_vigor_assessment=clean_numeric(data.get('initial_vigor_assessment', ''),int),
            number_of_planted_stakes_per_plot=clean_numeric(data.get('number_of_planted_stakes_per_plot', ''),int),
            plant_architecture_visual_rating=clean_numeric(data.get('plant_architecture_visual_rating', ''),int),
            plant_stands_harvested_counting=clean_numeric(data.get('plant_stands_harvested_counting', ''),int),
            poundability_assessment=clean_numeric(data.get('poundability_assessment', ''),int),
            proportion_lodged_plants_percentage=clean_numeric(data.get('proportion_lodged_plants_percentage', ''),float),
            root_neck_length_visual_rating=clean_numeric(data.get('root_neck_length_visual_rating', ''),int),
            root_number_counting=clean_numeric(data.get('root_number_counting', ''),int),
            rotted_storage_root_counting=clean_numeric(data.get('rotted_storage_root_counting', ''),int),
            specific_gravity=clean_numeric(data.get('specific_gravity', ''),float),
            sprout_count_nine_month=clean_numeric(data.get('sprout_count_nine_month', ''),int),
            sprout_count_one_month=clean_numeric(data.get('sprout_count_one_month', ''),int),
            sprout_count_six_month=clean_numeric(data.get('sprout_count_six_month', ''),int),
            sprout_count_three_month=clean_numeric(data.get('sprout_count_three_month', ''),int),
            sprouting_proportion=clean_numeric(data.get('sprouting_proportion', ''),float),
            storage_root_cortex_color_visual_rating=clean_numeric(data.get('storage_root_cortex_color_visual_rating', ''),int),
            storage_root_periderm_color_visual_rating=clean_numeric(data.get('storage_root_periderm_color_visual_rating', ''),int),
            storage_root_pulp_color_visual_rating=clean_numeric(data.get('storage_root_pulp_color_visual_rating', ''),int),
            storage_root_shape_visual_rating=clean_numeric(data.get('storage_root_shape_visual_rating', ''),int),
            storage_root_size_visual_rating=clean_numeric(data.get('storage_root_size_visual_rating', ''),int),
            taste_of_boiled_root_rating=clean_numeric(data.get('taste_of_boiled_root_rating', ''),int),
            top_yield=clean_numeric(data.get('top_yield', ''),float),
            total_carotenoid_chart_1_8=clean_numeric(data.get('total_carotenoid_chart_1_8', ''),float),
            total_carotenoid_iCheck_method=clean_numeric(data.get('total_carotenoid_iCheck_method', ''),float),
        )
        new_fielddata.save()
